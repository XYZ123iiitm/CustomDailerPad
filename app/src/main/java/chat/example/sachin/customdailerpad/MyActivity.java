...
public class MyActivity extends Activity implements OnTouchListener, OnClickListener,
        OnFocusChangeListener {
    private EditText mEt, mEt1; // Edit Text boxes
    private Button mBSpace,  mBack, mBChange, mNum;
    ...
    public void onClick(View v) {
        ...
        } else if (v != mBack && v != mBChange && v != mNum) {
            addText(v);
